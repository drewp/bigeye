...
# General arguments
SYS_LIBS      = $(patsubst %,$(ARDUINO_LIB_PATH)/%,$(ARDUINO_LIBS)) $(LOCAL_LIBS)
...
build-cli/libs/Adafruit_NeoPixel.o: Adafruit_NeoPixel/Adafruit_NeoPixel.cpp
	mkdir -p $(dir $@)
	$(CC) -c $(CPPFLAGS) $(CXXFLAGS) $< -o $@
build-cli/libs/DigisparkUSB/oddebug.o: DigisparkArduinoIntegration-master/libraries/DigisparkUSB/oddebug.c
	mkdir -p $(dir $@)
	$(CC) -c $(CPPFLAGS) $(CFLAGS) $< -o $@
build-cli/libs/DigisparkUSB/osccal.o: DigisparkArduinoIntegration-master/libraries/DigisparkUSB/osccal.c
	mkdir -p $(dir $@)
	$(CC) -c $(CPPFLAGS) $(CFLAGS) $< -o $@
build-cli/libs/DigisparkUSB/usbdrv.o: DigisparkArduinoIntegration-master/libraries/DigisparkUSB/usbdrv.c
	mkdir -p $(dir $@)
	$(CC) -c $(CPPFLAGS) $(CFLAGS) $< -o $@
build-cli/libs/DigisparkUSB/usbdrvasm.o: DigisparkArduinoIntegration-master/libraries/DigisparkUSB/usbdrvasm.S
	mkdir -p $(dir $@)
	$(CC) -c $(CPPFLAGS) $(ASFLAGS) $< -o $@
...
MICRONUCLEUS_DIR ?= .
dsupload: $(TARGET_HEX)
		$(MICRONUCLEUS_DIR)/micronucleus --run $(TARGET_HEX)
